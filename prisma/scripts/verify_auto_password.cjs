// Verification script for Prisma Auto-Password Extension
// This script must be run with the project environment setup

const { prisma } = require('./src/lib/prisma');
const bcrypt = require('bcryptjs');

async function testAutoPassword() {
  console.log('--- Testing Auto Password Generation ---');
